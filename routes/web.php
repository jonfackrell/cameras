...
Route::middleware(['mail'])->group(function () {
    ...
    Route::prefix('equipment')->name('equipment.')->namespace('Equipment')->group(function () {
        ...
        Route::group(['middleware' => ['cas.auth', 'patron.auth']], function() {
            ...
            Route::post('/authorize', 'PatronController@selfAuthorizeCameras')->name('patron.authorize');
        ...
        Route::group(['middleware' => ['auth']], function() {
            ...
            Route::get('/admin/checkouts/history', 'CheckoutController@index')->name('admin.checkouts.history');
