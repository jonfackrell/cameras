...
<a class="row btn btn-default sidebar-btn" href="{{ route('equipment.admin.checkouts') }}"><span class="col-3"><i class="fa fa-history" aria-hidden="true"></i></span><span class="col">History</span></a>
