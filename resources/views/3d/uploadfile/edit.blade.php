...
@section('content')
    <div style="float: right;">
        <div style="margin-top: 25px;">
            {!! BootForm::open()->action(route('3d.admin.reprint', $printjob))->post() !!}
            {!! BootForm::submit('Reprint')->class('btn btn-info') !!}
            {!! BootForm::close() !!}
        </div>
    </div>
    {!! BootForm::open()->action(route('3d.uploadfile.update', $printjob))->put()->enctype('multipart/form-data') !!}
        <div class="row">
            <div class="col-md-5">
    ...
    {!! BootForm::open()->action(route('3d.uploadfile.destroy', $printjob))->delete() !!}
                ...
                @foreach($printjob->files as $file)
                    <li>
                        <p>
                            ...
                            <a href="{{ route('3d.download', $file->filename) }}">{{ $file->original_filename }}</a>
                        </p>
                    </li>
                @endforeach
            </ul>
