...
class UploadFileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('3d.uploadfile.index', compact('printjobs', 'departments', 'filaments', 'patron'));
    ...
    public function edit($id)
    {
        ...
        return view('3d.uploadfile.edit', compact('printjob', 'departments','filaments', 'colors', 'patron'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('3d.admin', ["#$status"]);
    }
