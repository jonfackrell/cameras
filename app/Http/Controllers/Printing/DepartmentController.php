...
class DepartmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('3d.admin.department.index', compact('departments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('3d.department.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('3d.admin.department.edit', compact('department', 'statuses'));
    }
