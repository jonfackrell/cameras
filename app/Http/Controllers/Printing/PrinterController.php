...
class PrinterController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('3d.admin.printer.index', compact('printers','departments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('3d.printer.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('3d.admin.printer.edit', compact('printer'));
    }
